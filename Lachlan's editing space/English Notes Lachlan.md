...
First stanza focuses entirely on the surfer, while the second stanza is a warning/push to send the surfer home, and the third stanza wraps it up explaining why the warning was given. The main theme in my opinion would be the idea of working alongside or appreciating nature, while still respecting the dangers it can hold. The author ()
